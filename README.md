...
mcf7_vc_normalization.ipynb: The code is to convert the raw HiC matrix to explicitely normalized matrix which takes into account the bias due to chromatin accessibility of the restriction endonucleases.
